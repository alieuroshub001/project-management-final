...
import { Key, Lock, Mail, Eye, EyeOff, ArrowRight, LogIn, ShieldCheck } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Reset password for <span className="font-medium text-indigo-600">{email}</span>
          </p>
        </div>
