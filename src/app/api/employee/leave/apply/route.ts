// app/api/employee/leave/apply/route.ts
import { NextRequest, NextResponse } from 'next/server';
import { getServerSession } from 'next-auth/next';
import connectToDatabase from '@/lib/db';
import Leave, { ILeaveDocument } from '@/models/employee/Leave';
import LeaveBalance from '@/models/employee/LeaveBalance';
import { ILeaveCreateRequest, ILeaveApiResponse, ILeave } from '@/types/employee/leave';
